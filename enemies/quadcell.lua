...
function QuadCell:draw()
  ...
  love.graphics.setColor(stylesheet.enemies.QuadCell.bgColor)
  love.graphics.circle('fill', 0, -15, 18)
  love.graphics.circle('fill', 0, 15, 18)
  love.graphics.circle('fill', 15, -30, 18)
  love.graphics.circle('fill', 15, 30, 18)

  love.graphics.setColor(stylesheet.enemies.QuadCell.lineColor)
...
function QuadCell:checkCollisionWithRectangle(x, y, w, h)
  return (
    self:checkCollisionCircleRectangle(self.x, self.y - 15, 22, x, y, w, h)
    or
    self:checkCollisionCircleRectangle(self.x, self.y + 15, 22, x, y, w, h)
    or
    self:checkCollisionCircleRectangle(self.x + 15, self.y - 30, 22, x, y, w, h)
    or
    self:checkCollisionCircleRectangle(self.x + 15, self.y + 30, 22, x, y, w, h)
  )
end
