...
function Firewall:update(dt)
  if self.x + self.r < self.border then
...
function Firewall:draw()
  ...
  love.graphics.setColor(stylesheet.friendlies.Firewall.color:withAlpha(alpha))
